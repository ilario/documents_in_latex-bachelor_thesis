...
\documentclass[a4paper, italian, oneside
, 12pt
]{book}
...
\usepackage[pdftex,pdfsubject={Synthesis of conjugated polymers and quantum dots for photovoltaics applications},pdfkeywords={polythiophene, CdSe, ligand, surface, interfaces, bulk heterojunction, phosphonic acid ligand, Sonogashira, nanocrystals, excitons, photovoltaics, solar cells, ligand exchange, pyridine, poly(3-hexylthiophene), regioregular, GRIM, asymmetric termination},pdftitle={Tesi di laurea triennale di Ilario Gelmetti},colorlinks=true,linkcolor=blue,citecolor=blue]{hyperref} %%metainformazioni
%%%Didascalie
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Prima Pagina %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\AddToShipoutPicture*{\AtPageCenter{\makebox(0,0){\includegraphics[width=0.9\paperwidth]{Immagini_Tesi/logo_unipi/unilogo_big-sbiadito-indicizz.png}}}}
\begin{titlepage}
...
\end{titlepage}
\newpage \vspace*{8cm}
\pdfbookmark[0]{Dedica}{dedica} % Sets a PDF bookmark for the dedication
\begin{center}
\large {\it Dedicata a Luciano, mio padre.}
\end{center} 

\chapter*{Ringraziamenti}
\pdfbookmark[0]{Ringraziamenti}{ringraziamenti} % Sets a PDF bookmark for the acknowledements
...
\mainmatter
%%%%%%%%%%%%%%%%%%%%%% Capitolo 1 %%%%%%%%%%%%%%%%%%%%%%
\input{Capitoli_Tesi/tesi_intro}
\input{Capitoli_Tesi/tesi_scopo}
%%%%%%%%%%%%%%%%%%%%%% Capitolo 2 %%%%%%%%%%%%%%%%%%%%%%
\input{Capitoli_Tesi/tesi_lavoro}
%%%%%%%%%%%%%%%%%%%%%% Capitolo 3 %%%%%%%%%%%%%%%%%%%%%%
\input{Capitoli_Tesi/tesi_risultati}
\input{Capitoli_Tesi/tesi_conclusioni}
%%%%%%%%%%%%%%%%%%%%%% Capitolo 4 %%%%%%%%%%%%%%%%%%%%%%
\input{Capitoli_Tesi/tesi_sperimentale}
%%%%%%%%%%%%%%%%%%%% Bibliografia %%%%%%%%%%%%%%%%%%%%%%
